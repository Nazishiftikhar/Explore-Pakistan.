...
namespace Tour_Plan_Agency.Controllers
{
    public class tblAdminsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Admin_ID,Admin_Name,Admin_Password,Admin_Address,Admin_Phone,Admin_Email")] tblAdmin tblAdmin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Admin_ID,Admin_Name,Admin_Password,Admin_Address,Admin_Phone,Admin_Email")] tblAdmin tblAdmin)
        {
            if (ModelState.IsValid)
            {
